...
[![GitHub stars](https://img.shields.io/github/stars/Alpha-Park/genpark-shamir-secret-sharing-threshold-scheme-skill?style=social)](https://github.com/Alpha-Park/genpark-shamir-secret-sharing-threshold-scheme-skill/stargazers)
...
```bash
git clone https://github.com/Alpha-Park/genpark-shamir-secret-sharing-threshold-scheme-skill.git
